...
st.set_page_config(page_title="ML Model Inference App", layout="wide")

# App title and description
st.title("Machine Learning Model Inference Dashboard")
st.markdown("""
This app allows you to make predictions using pre-trained models by manually entering feature values.
""")
